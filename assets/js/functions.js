...
function onDocumentReady() {
  ...
  $('#overlay_slider_land')
    .addClass('slider_footer_v1')
    .removeClass('slider_footer_v2 slider_footer_v3 slider_footer_v4');
 ...
 */
  ...
  $('#index_timer').countdown('2018/12/12', function(event) {
    /* change date */
    $(this).html(
      event.strftime(
        ' <div class="time">%D<span class="label">days</span></div>' +
  ...
  $('#register_timer').countdown('2018/12/12', function(event) {
    /* change date */
    $(this).html(
      event.strftime(
        ' <div class="time">%D<span class="label">days</span></div>' +
...
var marker;
var marker_home = 'assets/img/icons/marker.png';
var marker_event = 'assets/img/icons/marker_event.png';
...
function initMap() {
  var map = new google.maps.Map(document.getElementById('map'), {
    zoom: 14,
    center: { lat: 30.5336, lng: -87.214598 },
    scrollwheel: false,
  ...
  marker = new google.maps.Marker({
    ...
    position: { lat: 30.5336, lng: -87.214598 },
    icon: marker_home,
  });
}
...
function initMap_contact() {
  var map = new google.maps.Map(document.getElementById('map'), {
    zoom: 17,
    center: { lat: 45.8641466, lng: 22.9099481 },
    scrollwheel: false,
  });
  ...
  marker = new google.maps.Marker({
    ...
    draggable: true,
    animation: google.maps.Animation.DROP,
    position: { lat: 45.8641466, lng: 22.9099481 },
    icon: marker_home,
  });
}
